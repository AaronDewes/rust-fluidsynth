...
impl Synth {
    ...
    pub fn get_settings(&self) -> Settings {
        unsafe { Settings::from_raw(fluid_synth_get_settings(self.c_fluid_synth)) }
    }
    ...
    pub fn noteoff(&self, chan: i32, key: i32) -> i32 {
        unsafe { fluid_synth_noteoff(self.c_fluid_synth, chan as c_int, key as c_int) }
    }
    ...
    pub fn pitch_bend(&self, chan: i32, val: i32) -> bool {
        unsafe { fluid_synth_pitch_bend(self.c_fluid_synth, chan as c_int, val as c_int) == 0 }
    }
    ...
    pub fn get_pitch_bend(&self, chan: i32) -> Option<i32> {
        unsafe {
            ...
            let res =
                fluid_synth_get_pitch_bend(self.c_fluid_synth, chan as c_int, ppitch as *mut c_int);
    ...
    pub fn get_pitch_wheel_sens(&self, chan: i32) -> Option<i32> {
        unsafe {
            ...
            let res = fluid_synth_get_pitch_wheel_sens(
                self.c_fluid_synth,
                chan as c_int,
                ppitch as *mut c_int,
            );
    ...
    pub fn bank_select(&self, chan: i32, bank: i32) -> bool {
        unsafe { fluid_synth_bank_select(self.c_fluid_synth, chan as c_int, bank as c_int) == 0 }
    }

    pub fn sfont_select(&self, chan: i32, sfont_id: i32) -> bool {
        unsafe {
            fluid_synth_sfont_select(self.c_fluid_synth, chan as c_int, sfont_id as c_int) == 0
        }
    }

    pub fn program_select(&self, chan: i32, sfont_id: i32, bank_num: i32, preset_num: i32) -> bool {
        unsafe {
    ...
    pub fn unset_program(&self, chan: i32) -> bool {
        unsafe { fluid_synth_unset_program(self.c_fluid_synth, chan as c_int) == 0 }
    }

    pub fn program_reset(&self) -> bool {
        unsafe { fluid_synth_program_reset(self.c_fluid_synth) == 0 }
    }

    pub fn system_reset(&self) -> bool {
        unsafe { fluid_synth_system_reset(self.c_fluid_synth) == 0 }
    }
    ...
    pub fn sfreload(&self, id: i32) -> bool {
        unsafe { fluid_synth_sfreload(self.c_fluid_synth, id as c_int) == 0 }
    }

    pub fn sfunload(&self, id: i32, reset_presets: bool) -> bool {
        unsafe {
    ...
    pub fn sfcount(&self) -> i32 {
        unsafe { fluid_synth_sfcount(self.c_fluid_synth) }
    }
    ...
    pub fn get_sfont_by_id(&self, id: i32) -> Option<SoundFont> {
        unsafe {
    ...
    pub fn get_bank_offset(&self, sfont_id: i32) -> i32 {
        unsafe { fluid_synth_get_bank_offset(self.c_fluid_synth, sfont_id as c_int) }
    }
    ...
    pub fn get_reverb_roomsize(&self) -> f64 {
        unsafe { fluid_synth_get_reverb_roomsize(self.to_raw()) }
    }

    pub fn get_reverb_damp(&self) -> f64 {
        unsafe { fluid_synth_get_reverb_damp(self.to_raw()) }
    }

    pub fn get_reverb_level(&self) -> f64 {
        unsafe { fluid_synth_get_reverb_level(self.to_raw()) }
    }
    ...
    pub fn set_chorus(
        ...
        const FLUID_OK_INT: c_int = FLUID_OK as c_int;
        match unsafe {
    ...
    pub fn get_chorus_nr(&self) -> i32 {
        unsafe { fluid_synth_get_chorus_nr(self.to_raw()) }
    }

    pub fn get_chorus_level(&self) -> f64 {
        unsafe { fluid_synth_get_chorus_level(self.to_raw()) }
    }

    pub fn get_chorus_speed_hz(&self) -> f64 {
        unsafe { fluid_synth_get_chorus_speed(self.to_raw()) }
    }

    pub fn get_chorus_depth_ms(&self) -> f64 {
        unsafe { fluid_synth_get_chorus_depth(self.to_raw()) }
    }

    pub fn get_chorus_type(&self) -> ChorusMod {
        unsafe { transmute(fluid_synth_get_chorus_type(self.to_raw())) }
    }

    pub fn count_midi_channels(&self) -> i32 {
        unsafe { fluid_synth_count_midi_channels(self.to_raw()) }
    }

    pub fn count_audio_channels(&self) -> i32 {
        unsafe { fluid_synth_count_audio_channels(self.to_raw()) }
    }

    pub fn count_audio_groups(&self) -> i32 {
        unsafe { fluid_synth_count_audio_groups(self.to_raw()) }
    }

    pub fn count_effects_channels(&self) -> i32 {
        unsafe { fluid_synth_count_effects_channels(self.to_raw()) }
    }

    pub fn set_sample_rate(&self, sample_rate: f32) {
        unsafe { fluid_synth_set_sample_rate(self.to_raw(), sample_rate as c_float) }
    }

    pub fn set_gain(&self, gain: f32) {
        unsafe { fluid_synth_set_gain(self.to_raw(), gain as c_float) }
    }

    pub fn get_gain(&self) -> f32 {
        unsafe { fluid_synth_get_gain(self.to_raw()) }
    }

    pub fn set_polyphony(&self, polyphony: i32) -> bool {
        unsafe { fluid_synth_set_polyphony(self.to_raw(), polyphony as c_int) == 0 }
    }

    pub fn get_polyphony(&self) -> i32 {
        unsafe { fluid_synth_get_polyphony(self.to_raw()) }
    }

    pub fn get_active_voice_count(&self) -> i32 {
        unsafe { fluid_synth_get_active_voice_count(self.to_raw()) }
    }

    pub fn get_internal_bufsize(&self) -> i32 {
        unsafe { fluid_synth_get_internal_bufsize(self.to_raw()) }
    }
    ...
    pub fn get_gen(&self, chan: i32, param: i32) -> f32 {
        unsafe { fluid_synth_get_gen(self.to_raw(), chan as c_int, param as c_int) }
    }
    ...
    pub fn deactivate_tuning(&self, chan: i32, apply: bool) -> bool {
        unsafe { fluid_synth_deactivate_tuning(self.to_raw(), chan as c_int, apply as c_int) == 0 }
    }

    pub fn tuning_iteration_start(&self) {
        unsafe { fluid_synth_tuning_iteration_start(self.to_raw()) }
    }
    ...
    pub fn get_cpu_load(&self) -> f64 {
        unsafe { fluid_synth_get_cpu_load(self.to_raw()) }
    }
    ...
    pub fn write_f32(&self, len: usize, left: &mut Vec<f32>, right: &mut Vec<f32>) -> bool {
        ...
        unsafe {
            result = fluid_synth_write_float(
                self.to_raw(),
                len as c_int,
                left.get_unchecked_mut(left_current) as *mut f32 as *mut ::libc::c_void,
                0,
                1,
                right.get_unchecked_mut(right_current) as *mut f32 as *mut ::libc::c_void,
                0,
                1,
            ) == 0;
            if result {
