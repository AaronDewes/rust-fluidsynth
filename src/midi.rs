...
impl MidiRouter {
    pub fn new<T: Fn(MidiEvent) -> i32>(settings: &mut Settings, callback: T) -> MidiRouter {
        unsafe {
            ...
            let router = new_fluid_midi_router(
                settings.to_raw(),
                Some(midi_router_callback_wrapper::<T>),
                user_data,
            );
        ...
        extern "C" fn midi_router_callback_wrapper<T>(
            closure: *mut c_void,
    ...
    pub fn set_default_rules(&self) -> bool {
        unsafe { fluid_midi_router_set_default_rules(self.to_raw()) == 0 }
    }

    pub fn clear_rules(&self) -> i32 {
        unsafe { fluid_midi_router_clear_rules(self.to_raw()) }
    }

    pub fn add_rule(&self, rule: &mut MidiRouterRule, rule_type: MidiRouterRuleType) -> i32 {
        unsafe { fluid_midi_router_add_rule(self.to_raw(), rule.to_raw(), rule_type as c_int) }
    }
...
impl MidiRouterRule {
    ...
    pub fn dump_prerouter(&self, event: &MidiEvent) -> bool {
        unsafe { fluid_midi_dump_prerouter(self.to_raw() as *mut c_void, event.to_raw()) == 0 }
    }

    pub fn dump_postrouter(&self, event: &MidiEvent) -> bool {
        unsafe { fluid_midi_dump_postrouter(self.to_raw() as *mut c_void, event.to_raw()) == 0 }
    }
    ...
    pub fn new<T: Fn(MidiEvent) -> i32>(settings: &mut Settings, callback: T) -> MidiDriver {
        unsafe {
            ...
            let router = new_fluid_midi_driver(
                settings.to_raw(),
                Some(midi_driver_callback_wrapper::<T>),
                user_data,
            );
        ...
        extern "C" fn midi_driver_callback_wrapper<T>(
            closure: *mut c_void,
            event: *mut fluid_midi_event_t,
        ) -> i32
        where
...
impl MidiEvent {
    ...
    pub fn get_type(&self) -> i32 {
        unsafe { fluid_midi_event_get_type(self.to_raw()) }
    }
    ...
    pub fn get_channel(&self) -> i32 {
        unsafe { fluid_midi_event_get_channel(self.to_raw()) }
    }
    ...
    pub fn get_key(&self) -> i32 {
        unsafe { fluid_midi_event_get_key(self.to_raw()) }
    }
    ...
    pub fn get_velocity(&self) -> i32 {
        unsafe { fluid_midi_event_get_velocity(self.to_raw()) }
    }
    ...
    pub fn get_control(&self) -> i32 {
        unsafe { fluid_midi_event_get_control(self.to_raw()) }
    }
    ...
    pub fn get_value(&self) -> i32 {
        unsafe { fluid_midi_event_get_value(self.to_raw()) }
    }
    ...
    pub fn get_program(&self) -> i32 {
        unsafe { fluid_midi_event_get_program(self.to_raw()) }
    }
    ...
    pub fn get_pitch(&self) -> i32 {
        unsafe { fluid_midi_event_get_pitch(self.to_raw()) }
    }
...
impl Player {
    ...
    pub fn join(&self) -> bool {
        unsafe { fluid_player_join(self.to_raw()) == 0 }
    }
    ...
    pub fn get_status(&self) -> PlayerStatus {
        unsafe { transmute(fluid_player_get_status(self.to_raw())) }
    }
